...
const brandTokens = {
  colors: {
    ...
    dark: {
      primaryRed: '#FF6B85',
      primaryRedHover: '#FF5A7A',
      textPrimary: '#E8E8EA',
      textSecondary: '#98989A',
      textDisabled: '#6D6D70',
      background: '#121214',
      backgroundSecondary: '#1E1E20',
      backgroundMuted: '#28282A',
      surface: '#1E1E20',
      surfaceElevated: '#28282A',
      border: '#3A3A3C',
      borderLight: '#48484A',
      success: '#32D74B',
      warning: '#FF9500',
  ...
  shadows: {
    ...
    dark: {
      ...
      medium: '0 2px 4px rgba(0, 0, 0, 0.10)',
...
const createAppTheme = (mode: PaletteMode) => {
  ...
  return createTheme({
    palette: {
      ...
      grey: {
        50: isDark ? '#28282A' : '#FAFAFA',
        100: isDark ? '#1E1E20' : '#F5F5F5',
        200: isDark ? '#3A3A3C' : '#EEEEEE',
        300: isDark ? '#48484A' : '#E0E0E0',
        400: isDark ? '#6D6D70' : '#BDBDBD',
        500: isDark ? '#98989A' : '#9E9E9E',
        600: isDark ? '#AEAEB0' : '#757575',
        700: isDark ? '#C7C7C9' : '#616161',
        800: isDark ? '#D1D1D3' : '#424242',
        900: isDark ? '#E8E8EA' : '#212121',
      },
    },
    typography: {
